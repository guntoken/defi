...
import "./ProCodeToken.sol";

contract DBank {

  ProCodeToken private token;
  ...
  constructor(ProCodeToken _token) {
    token = _token;
  }
  ...
  function withdraw() public {
    ...
    uint interestPerSecond = 31688087 * (etherBalanceOf[msg.sender] / 1e16);
  ...
  function payOff() public {
    ...
    require(allowance >= (collateralEther[msg.sender] / 2), "Check the token allowance");
    ...
    token.transferFrom(msg.sender, address(this), collateralEther[msg.sender] / 2); //must approve dBank 1st
